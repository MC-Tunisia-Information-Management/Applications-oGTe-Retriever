function getOpportunityApplications_oGTe() {
  var graphQLQuery = `
      query AllOpportunityApplication {
        allOpportunityApplication(
          filters: {
            person_committee: lc_id,
            created_at: { from: "2024-02-01T00:00:00Z", to: "2025-02-01T00:00:00Z" },
            programmes: 9
          },
  ...
  var sheet = spreadsheet.getSheetByName("📖 applications | oGTe");
